...
def main():
    ...
    class CustomResNet(ResNet):
        def __init__(self, num_classes=10):
            ...
            # TODO: change model params here.
            # super(CustomResNet, self).__init__(BasicBlock, [2, 2, 2, 2], num_classes=num_classes) # resnet18
            super(CustomResNet, self).__init__(BasicBlock, [3, 4, 6, 3], num_classes=num_classes)  # resnet34
            # super(CustomResNet, self).__init__(Bottleneck, [3, 4, 6, 3], num_classes=num_classes)  # resnet50
